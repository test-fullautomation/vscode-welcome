...
\begin{enumerate}
    \item Look for the setting named \texttt{robotframeworkWelcome.welcomeUrl} in the \texttt{settings.json} of vscode.
    \item Enter the desired URL (e.g., \url{https://your-custom-url.com}) or a local file path (e.g., \texttt{path/to/file.html}).
